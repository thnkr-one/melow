...
ActiveRecord::Schema[8.0].define(version: 2024_10_04_001838) do
  ...
  create_table "orders", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "store_type_id", null: false
    t.string "month"
    t.integer "year"
    t.integer "amount"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["store_type_id"], name: "index_orders_on_store_type_id"
  end
  ...
  add_foreign_key "orders", "store_types"
