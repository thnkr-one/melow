class AddImportTypes < ActiveRecord::Migration[8.0]
  # Define a lightweight version of the Import model for use in the migration
  ...
  def change
    ...
    # Use the lightweight version of the Import model to update records
    Import.update_all(type: "TransactionImport")

    change_column_null :imports, :type, false

    # Add import references to associate imported resources
