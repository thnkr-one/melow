class Accounts::TransactionsController < ApplicationController
  ...
  def update
    ...
    respond_to do |format|
      format.html {
        redirect_to account_entry_path(@account, @entry), notice: "success"
      }
      format.turbo_stream {
...
private
  ...
  def entry_params
    ...
    .permit(:name, :date, :amount, :currency, :entryable_type, :nature,
      entryable_attributes: [:id, :notes, :excluded, :category_id, :merchant_id, { tag_ids: [] }]
